...
@section('content')
	{!! Form::open(['route' => 'backend.users.store', 'class' => 'forms form-horizontal js-call-form_validation']) !!}
	<div class="row">
		<div class="col-md-12">
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title">{{ trans('users::backend.create.title') }}</h3>
				</div>
				<div class="box-body">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="box box-solid">
				...
				<div class="box-body">
					{!! Widget::field_address('primary', ['type' => 'primary', 'address' => null, 'show_country' => true, 'show_state' => true]) !!}
				</div>
			</div>
		</div>
	</div>
				...
				<div class="box-body">
					...
					<div class="pull-right">
						<button class="btn btn-primary btn-flat" type="submit">
							<i class="fa fa-user-plus"></i> {{ trans('users::backend.create.btn.add_user') }}
						</button>
					</div>
				</div>
			</div>
